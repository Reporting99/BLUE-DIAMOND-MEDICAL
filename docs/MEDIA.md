...
| File | Reason |
|---|---|
| `medical/blue-diamond-medical-logo.png` | Low-resolution legacy web logo; superseded by the lock-up the client supplied on 2026-09-07, now bundled at `src/assets/brand/blue-diamond-medical-logo.png` |
