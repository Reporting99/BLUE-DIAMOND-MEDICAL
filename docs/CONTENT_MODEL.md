...
- `src/content/concerns.ts` — 9 concern pages, including the note on 3 concerns whose treatment cross-link was editorially corrected from the source (see `docs/CONTENT_MODEL.md`).
