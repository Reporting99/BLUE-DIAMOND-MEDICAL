...
| Aesthetic concern | 11 | all published — the Treatments menu and hub ARE this list (concern-first IA); no separate concerns hub |
...
| `concern-unwanted-hair` | Aesthetic concern | Unwanted Hair | `/aesthetics/treatments/unwanted-hair` | `/التجميل-الطبي/العلاجات/الشعر-غير-المرغوب-فيه` | B4 (669–731) | treatment-laser-hair-removal, technology-elite-iq, concern-razor-bumps | Added with the concern-first IA. Restates the approved Laser Hair Removal content as the patient problem; no new claim | Published |
| `concern-hair-loss` | Aesthetic concern | Hair Loss | `/aesthetics/treatments/hair-loss` | `/التجميل-الطبي/العلاجات/تساقط-الشعر` | B9 (947–973) | treatment-prp-hair-restoration, doctor-farhat | Added with the concern-first IA. Restates the approved PRP Hair Restoration content as the patient problem; no new claim | Published |
| `concern-acne-scars` | Aesthetic concern | Acne Scars | `/aesthetics/treatments/acne-scars` | `/التجميل-الطبي/العلاجات/ندبات-حب-الشباب` | B12 (1073–1083) | treatment-rf-microneedling, treatment-prp-skin-rejuvenation, shop-concern-acne | Reclassified from treatment | Published |
| `concern-rosacea-redness` | Aesthetic concern | Rosacea & Redness | `/aesthetics/treatments/rosacea-redness` | `/التجميل-الطبي/العلاجات/الوردية-والاحمرار` | B13 (1085–1095) | treatment-laser-skin-treatments, shop-concern-redness | Reclassified; link retargeted | Published |
| `concern-dry-skin` | Aesthetic concern | Dry Skin | `/aesthetics/treatments/dry-skin` | `/التجميل-الطبي/العلاجات/جفاف-البشرة` | B14 (1097–1107) | treatment-rf-microneedling, shop-concern-dry-skin | Reclassified | Published |
| `concern-fine-lines-wrinkles` | Aesthetic concern | Fine Lines & Wrinkles | `/aesthetics/treatments/fine-lines-wrinkles` | `/التجميل-الطبي/العلاجات/الخطوط-الدقيقة-والتجاعيد` | B15 (1109–1119) | treatment-rf-microneedling, treatment-radio-frequency, treatment-cosmetic-botox, shop-concern-anti-aging | Reclassified | Published |
| `concern-skin-laxity` | Aesthetic concern | Skin Laxity | `/aesthetics/treatments/skin-laxity` | `/التجميل-الطبي/العلاجات/ترهل-البشرة` | B16 (1121–1131) | treatment-radio-frequency, treatment-rf-microneedling | Reclassified from "Non-invasive Skin Tightening", which named the modality not the concern | Published |
| `concern-spider-veins` | Aesthetic concern | Spider Veins | `/aesthetics/treatments/spider-veins` | `/التجميل-الطبي/العلاجات/الأوردة-العنكبوتية` | B17 (1133–1143) | treatment-laser-skin-treatments | Reclassified; link retargeted | Published |
| `concern-sun-damage-pigmentation` | Aesthetic concern | Sun Damage & Pigmentation | `/aesthetics/treatments/sun-damage-pigmentation` | `/التجميل-الطبي/العلاجات/تلف-الشمس-والتصبغ` | B18 (1145–1155) | treatment-laser-skin-treatments, treatment-ultra, shop-concern-pigmentation | Reclassified; link retargeted | Published |
| `concern-skin-revitalization` | Aesthetic concern | Skin Revitalization | `/aesthetics/treatments/skin-revitalization` | `/التجميل-الطبي/العلاجات/تجديد-البشرة` | B19 (1157–1167) | treatment-laser-skin-treatments, treatment-rf-microneedling, treatment-ultra | Reclassified; both links retargeted | Published |
| `concern-razor-bumps` | Aesthetic concern | Razor Bumps | `/aesthetics/treatments/razor-bumps` | `/التجميل-الطبي/العلاجات/حبوب-الحلاقة` | B20 (1169–1179) | treatment-laser-hair-removal | Reclassified; link verified correct and retained | Published |
...
| `shop-hub` | Product category (hub) | Products | `/shop` | `/المتجر` | A12 (497–570); B1 (594–596) | 8 categories, 6 product concerns, 31 products (Myriade; the 23 SkinMedica records were archived 2026-09-07 — `docs/archive/SKINMEDICA_ARCHIVE.md`) | Orphan legacy page + the aesthetics site's dead "SHOP Now" button both resolve here | Published |
...
| `booking:family-doctor` | Booking destination | Mikata | n/a | n/a | A1 (33); A2 (94); A4 (×6) | 6 doctors, medical services | — | Structured fact (external) |
| `booking:walk-in` | Booking destination | Skip the Waiting Room | n/a | n/a | A2 (92); A3 (192–196) | book-appointment | — | Structured fact — STWR host pending approval (GAP-010) |
