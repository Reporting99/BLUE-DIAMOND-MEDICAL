...
| GAP-021 | Global brand mark | The supplied Blue Diamond logo PNG (CL-001) | `Blue Diamond Medical Clinic-logo2024-01-15_22-09-36-b10847c6-org-427.png` is not present on the build machine | Yes | `Logo`/`BrandLockup` continue to render the documented inline `DiamondMark` stand-in. Swap is a one-file code change | Client |
