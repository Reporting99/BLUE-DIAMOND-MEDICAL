...
export const imageManifest: ImageKitAsset[] = [
  ...
  // Live aesthetic treatments only — generated from src/content/treatments.ts
  ...
  // Technology devices — generated from src/content/technologies.ts.
  ...
  // src/content/medical-services.ts, plus one manual entry for Uninsured
  ...
  // Concern-explorer imagery — generated from src/content/concerns.ts.
  ...concerns.map(
    (c): ImageKitAsset => ({
      id: `concern-${c.id}`,
