...
export const beforeAfterPairs: BeforeAfterPair[] = [
  ...
  },
  {
    ...
    after: {
      ...
      alt: { en: "Clinical example after PRP Hair Restoration", ar: "مثال سريري بعد استعادة الشعر بالبلازما" },
  ...
  },
  {
    ...
    after: {
      ...
      alt: { en: "Clinical example after Ultra", ar: "مثال سريري بعد ألترا" },
