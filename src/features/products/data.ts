...
export const products: Product[] = [
  ...
  },
  {
    ...
    inStock: true,
    detail: {
      overview: { en: "An evening serum formulated to address the appearance of stubborn skin discolouration.", ar: "سيروم مسائي مصمم لمعالجة مظهر تصبغات البشرة العنيدة." },
