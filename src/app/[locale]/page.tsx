              ...
              {medicalPathwayMedia ? (
                <>
                  <ImageKitImage
                    ...
                    version={medicalPathwayMedia.version}
                    preset="hero"
            ...
            >
              ...
              {aestheticsPathwayMedia ? (
                <ImageKitImage
                  ...
                  version={aestheticsPathwayMedia.version}
                  preset="hero"
              ...
              >
                <div className="facet-corner-sm aspect-square overflow-hidden rounded">
                  <ImageKitImage
                    ...
                    version={(featured(`product:${product.id}`, "productPrimary") ?? product.images[0]!).version}
                    preset="product"
                    role="product"
