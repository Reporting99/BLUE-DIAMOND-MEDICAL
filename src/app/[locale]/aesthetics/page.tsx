...
export default async function AestheticsHubPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const copy = {
    en: {
      ...
      exploreHeading: "Explore your options",
      byTreatment: { title: "Treatments", body: "Start from what you'd like to treat — acne scars, unwanted hair, fine lines — and see the treatment options we offer." },
